...
<HTML>
	...
	<body leftmargin=30px>
		...
		<tr><td><span class=heading_medium_blue>Southwest Freeway (US 59) Construction Update, August 13, 2005
		</span></td></tr>
		
		<tr><td>
		<P>
		<em>Last updated May 3, 2006</em>
		<P>
		...
		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_montrose_looking_e_from_mandell_2005-08-12_8a_950.jpg">
		<br>
		This view looks east from the Mandell overpass, showing that the trench is just about
		completely excavated.

		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_montrose_looking_e_from_mandell_2005-08-12_1a _950.jpg">
		<br>
		This view looks east from the Mandell overpass, showing the traffic lanes on the future
		northbound side of the freeway.

		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_montrose_graustark_2005-08-12_4a_950.jpg">
		<br>
		This view shows the arch for the bridge at Graustark.

		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_montrose_looking_e_from_montrose_2005-08-12_3a_950.jpg">
		<br>
		This view shows the split at Spur 527, looking east from the Montrose overpass.


		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_at_bw8_landscaping_2005-08-13_15a_ADJ_950.jpg">
		<br>
		...
		<a href="http://www.houstonarchitecture.info/haif/index.php?showtopic=4625">HoustonArchitecture.info</a>
...
water. ...
<p> The guy [at the nursery] was pretty up front about them. I think
...
plantings. <P>Other drawbacks that the nursery guy said was the
...
sterile.<P>They are really cool looking trees though and fast growing."
</span>
		</blockquote>
		

		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_at_bw8_landscaping_2005-08-13_14a_950.jpg">
		<br>
		Here is another view of the Galveston Eucalyptus.

		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_at_university_looking_ne_2005-08-13_18a_950.jpg">
		<br>
		...
		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_at_university_looking_ne_2005-08-13_20a_950.jpg">
		<br>
		...
		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_at_university_looking_se_2005-08-13_22a_950.jpg">
		<br>
		...
		<P>
		<img src="<%=System.Web.Configuration.WebConfigurationManager.AppSettings["ImagePath"] %>images/us59_2005-08-13/59s_at_university_looking_sw_2005-08-13_23a_950.jpg">
		<br>
